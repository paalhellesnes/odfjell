...
#         """
#         self.patterns[pattern.shift_pattern_id] = pattern


#     def get_activity_by_id(self, shift_pattern_id):
#         """
#         Retreive a activity shift pattern object from the collection with a given shift pattern ID.

#         Parameters:
#         - shift_pattern_id (int): The shift pattern ID for which we wish to retreive the activity shift pattern object.
#         """
#         return self.patterns.get(shift_pattern_id, None)
...
#             print("No activity shift patterns in the collection.")
#         else:
#             print("List of activity shift patterns:")
#             for index, pattern in self.patterns.items():
#                 print(f"  Activity Shift Pattern [{index}] {pattern}:")
...
#         for index, pattern in self.patterns.items():
#             data["ShiftPatternID"].append(index)
