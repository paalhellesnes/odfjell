...
#         propeople_activity_shift_pattern_collection.list_patterns()


#     def test_ActivityShiftPatternCollection_get_activity_by_id(self):
#         expected_repr = "N7D7 - NNNNNNNDDDDDDD"
...
#         propeople_activity_shift_pattern = propeople_activity_shift_pattern_collection.get_activity_by_id(
#             shift_pattern_id = 3)
...
# tests.test_ActivityShiftPatternCollection_get_activity_by_id()
